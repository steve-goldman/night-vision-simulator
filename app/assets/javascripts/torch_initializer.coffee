class @TorchInitializer
  initialize: =>
    ...
    logger       = new MessageLogger('#server-log')
    subscriber   = new Subscriber channel, logger, torchStarter.setFrequency, torchStarter.setProbability, torchStarter.setDutyCycle 
